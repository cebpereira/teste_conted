...
@section('htmlheader_title', 'Visualizar Usuário')
            ...
            <div class="col-12" >
                <div class="card shadow-2-strong card-registration">
                     <div class="card-body p-4 p-md-5">
                        <div class="col-sm-6">
                            <h2>Visualizando usuário: {{ $user->nome }}</h2><br>
                        </div>
                        ...
                        <form method="GET" action="{{ route('user.view', ['id' => $modelo->id]) }}" >
                            @csrf
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text"  id="nome" name="nome"
                                        class="form-control @error('nome') is-invalid @enderror" value="{{ $modelo->nome }}" readonly>
                                    @error('nome')
                                ...
                                <div class="form-group col-md-3 offset-md-1">
                                    ...
                                    <input type="text"  name="telefone" id="telefone"
                                        class="form-control @error('telefone') is-invalid @enderror" value="{{ $modelo->telefone }}" readonly>
                                    @error('telefone')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3 offset-md-1">
                                        ...
                                        <input type="text"  name="cpf" id="cpf"
                                            class="form-control @error('cpf') is-invalid @enderror" value="{{ $modelo->cpf }}" readonly>
                                        @error('cpf')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-5 offset-md-1">
                                    ...
                                    <input type="text"  name="endereco" id="endereco"
                                        ...
                                        value="{{ $modelo->endereco }}" readonly>
                                    @error('endereco')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group col-md-3 offset-md-1">
                                    ...
                                    <input id="estado" type="estado" class="form-control @error('estado') is-invalid @enderror"
                                        name="estado" value="{{ $modelo->estado }}"" readonly>
                                    @error('estado')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3" id="tamanhoDivCidade">
                                    ...
                                    <input id="cidade" type="cidade" class="form-control @error('cidade') is-invalid @enderror"
                                        name="cidade" value="{{ $modelo->cidade }}" readonly>
                                    @error('cidade')
                                ...
                                <div class="form-group col-md-3 offset-md-1">
                                    ...
                                    <input type="text"  id="complemento" name="complemento"
                                        ...
                                        value="{{ $modelo->complemento }}" readonly>
                                    @error('complemento')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                                        name="email" value="{{ $modelo->email }}" readonly>
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group col-md-3 offset-md-1">
                                    ...
                                    <div class="input-group">
                                        <input type="password"  name="password" id="password"
                                            class="form-control @error('password') is-invalid @enderror show-password" value="{{ $modelo->password }}" readonly>
                                ...
                                <div class="form-group col-md-3 offset-md-1">
                                    ...
                                    <div class="input-group">
                                        <input type="password"  name="password_confirmation" id="password-confirm"
                                            class="form-control @error('password_confirmation') is-invalid @enderror show-password-confirm" value="{{ $modelo->password }}" readonly>
                                        <div class="input-group-append">
                                            <div class="input-group-text">
